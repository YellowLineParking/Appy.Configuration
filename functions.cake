public class ProjectTaskConfigurationManager
{
	...
	{
		{ "Clean"	, new HashSet<string>(new string[] { "App", "Package", "XUnit" }) },
		{ "Build"	, new HashSet<string>(new string[] { "App", "Package", "XUnit" }) },
		{ "Test"	, new HashSet<string>(new string[] { "XUnit" }) },
...
public static string BuildProjectPath(string basePath, ProjectConfigDescriptor projectConfig) =>
